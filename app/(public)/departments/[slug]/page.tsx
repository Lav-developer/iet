...
import { selectDepartmentContact } from "@/lib/public-content";
...
export default async function DepartmentPage({ params }: { params: Promise<{ slug: string }> }) {
  ...
  const contact = selectDepartmentContact(data.faculty, department.slug);
